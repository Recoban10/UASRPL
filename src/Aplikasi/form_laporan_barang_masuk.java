 ...
 * @author Tedy Hidayat
 */
public class form_laporan_barang_masuk extends javax.swing.JFrame {
    Connection conn;
    Statement stat;
    ResultSet rs;
     ...
     */
    public form_laporan_barang_masuk() {
        initComponents();
        koneksi_database();
        tampil_barang_masuk();
    ...
    private void print(){
        try {
            String NamaFile = "./src/report_barang_masuk/report_barang_masuk.jasper";
            Class.forName("com.mysql.jdbc.Driver").newInstance();
            Connection koneksiConnection = DriverManager.getConnection("jdbc:mysql://localhost/" + "db_inventory", "root", "");
            ...
            JasperPrint JPrint = JasperFillManager.fillReport(NamaFile, hash, koneksiConnection);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_laporan_barang_masuk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_laporan_barang_masuk().setVisible(true);
            }
        });
    }
